...
test("D.1 desktop-only eligible fixture passes end-to-end", () => {
  runFixture(loadFixture("d1_desktop_only_eligible.json"));
});

test("D.2 desktop and mobile eligible fixture passes end-to-end", () => {
  runFixture(loadFixture("d2_desktop_and_mobile_eligible.json"));
});

test("D.3 desktop eligible mobile constrained fixture passes end-to-end", () => {
  runFixture(loadFixture("d3_desktop_eligible_mobile_constrained.json"));
});